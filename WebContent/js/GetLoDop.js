...
function getLodop(oOBJECT,oEMBED){
	        var strHtmInstall="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='../ocx/install_lodop32.exe' target='_blank'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
	        var strHtmUpdate="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='../ocx/install_lodop32.exe' target='_blank'>执行升级</a>,升级后请重新进入。</font>";
	        var strHtm64_Install="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='../ocx/install_lodop64.exe' target='_blank'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
	        var strHtm64_Update="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='../ocx/install_lodop64.exe' target='_blank'>执行升级</a>,升级后请重新进入。</font>";
		...
		try {
			...
			//*****如下空白位置适合调用统一功能:*********	     
			LODOP.SET_LICENSES("深圳市警视通实业有限公司", "1234567890",
					"", "");
